...
class Day21Test {
    ...
    void testSample1() {
        ...
        List<String> lines = ResourceHelper.loadLinesFromFile("Day21/sample1.txt");
    ...
    @Test
    void testSolution1() {
        List<String> lines = ResourceHelper.loadLinesFromFile("Day21/input1.txt");
    ...
    void testSample2() {
        ...
        List<String> lines = ResourceHelper.loadLinesFromFile("Day21/sample2.txt");
